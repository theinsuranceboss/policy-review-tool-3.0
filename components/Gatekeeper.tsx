...
const Gatekeeper: React.FC<GatekeeperProps> = ({ onUnlock }) => {
  ...
  return (
    <div className="min-h-[85vh] flex flex-col items-center justify-center p-4 animate-in fade-in duration-1000">
      <div className="w-full max-w-lg bg-[#0d0d0d] border border-white/10 rounded-[3rem] p-10 md:p-14 shadow-2xl relative overflow-hidden flex flex-col justify-center">
        ...
        <div className="space-y-10 text-center relative z-10">
          <div className="space-y-4">
            <div className="flex items-center justify-center mb-6">
              <div className="w-20 h-20 rounded-2xl overflow-hidden border border-white/10 bg-black/40 flex items-center justify-center p-2">
                <img 
          ...
          <form onSubmit={handleVerify} className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <button 
                ...
                className="w-full bg-white/5 text-gray-400 border border-white/10 font-black py-4 rounded-2xl hover:bg-white/10 hover:text-white transition-all uppercase text-[10px] tracking-widest"
              >
      ...
      {/* Modal / Overlay for Zapier Form */}
      {showZapier && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/90 backdrop-blur-md animate-in fade-in duration-300">
          <div className="w-full max-w-2xl bg-[#0a0a0a] border border-white/10 rounded-[3rem] p-6 shadow-2xl relative overflow-hidden flex flex-col max-h-[90vh]">
            <div className="flex justify-between items-center mb-6 px-4">
              <h3 className="text-yellow-400 font-bold text-sm tracking-widest uppercase">Request Authorization</h3>
              <button 
                onClick={() => setShowZapier(false)}
            ...
            <div className="rounded-2xl overflow-hidden bg-black border border-white/5 flex-grow overflow-y-auto">
              <ZapierEmbed 
